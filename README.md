...
Currently, Teddy only supports x86 and x86_64 processors with support for the
SSSE3 SIMD instructions. Moreover, it requires a nightly rust compiler. To set
...
configure `rustc` to support the required SIMD instructions. Assuming that you
are compiling only for your local machine, you can do this by compiling your
...
If you want more control over the SIMD instruction set that is used, you can
use instead
